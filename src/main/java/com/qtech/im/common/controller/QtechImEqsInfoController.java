...
public class QtechImEqsInfoController {
    ...
    @GetMapping("/aa/index")
    public R<List<ImEqsNetAndRemoteInfo>> listEqsInfo(ImEqsNetAndRemoteInfo imEqsNetAndRemoteInfo) {
        return R.ok(qtechImEqsInfoService.listEqsInfo(imEqsNetAndRemoteInfo));
    }
